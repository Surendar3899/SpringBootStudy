package com.revotran.employeesystem.service;
...
import com.revotran.employeesystem.repository.EmployeeRepository;
...
public class EmployeeService {
    ...
    public Employee updateEmployee(Long employeeId, Employee updatedEmployee) {
        Employee existingEmployee = employeeRepository.findByIdAndIsDeletedFalse(employeeId)
